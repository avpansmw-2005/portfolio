...
const azureSenderEmail = window.env?.VITE_AZURE_SENDER_EMAIL ??
  import.meta.env.VITE_AZURE_SENDER_EMAIL ?? "";
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 px-5 py-2 border-b border-taupe/10 shrink-0">
              <a href="https://github.com/avpansmw-2005" target="_blank" rel="noopener noreferrer" title="GitHub" className="w-9 h-9 rounded-full bg-eerieBlack/60 flex items-center justify-center border border-taupe/20 hover:border-[#915EFF] transition-all duration-200">
